    ...
    <div class="container-fluid text-center text-md-left">
        <div class="row">
            ...
            <div class="col-md-2 mx-auto text-dark">
                ...
                <ul class="list-unstyled">
                   <li><p><i class="fa fa-map-marker fa-2x mr-1"></i>Central Philippines University, Lopez Jaena Street, Anahaw Road, Jaro, Iloilo City, 5000 Iloilo</p></li>
                   <li><p><i class="fa fa-mobile fa-2x mr-1"></i>
                   (033) 652 2136</p> </li>
                   <li><p><i class="fa fa-envelope fa-2x mr-1"></i>cpu_cot@gmail.com</p></li>
                   <li><p><i class="fa fa-clock-o fa-2x mr-1"></i> Monday to Friday: 8am - 5pm<br></p></li>
                </ul>
            </div>
